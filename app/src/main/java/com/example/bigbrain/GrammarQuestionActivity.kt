...
import kotlinx.android.synthetic.main.activity_grammar_question.*
import java.util.*
import kotlin.collections.ArrayList


class GrammarQuestionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Grammar.getQuestions()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when { mCurrentPosition <= mQuestionsList!!.size -> {
                        ...
                        setQuestion()
                            ...
                            val intent = Intent(this@GrammarQuestionActivity, ResultActivity::class.java)
